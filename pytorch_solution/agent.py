...
UPDATE_TIMES = 10       # How many interleaved episodes to learn
T_PER_UPDATE = 20       # How many times update per learn
...
class Agent():
    ...
    def step(self, states, actions, rewards, next_states, dones, timestep):
        ...
        if len(self.memory) > BATCH_SIZE and timestep % T_PER_UPDATE == 0:
